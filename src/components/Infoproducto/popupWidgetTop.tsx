  ...
  return (
    <div>
      <Disclosure>
        {({ open }) => (
          <>
            <Disclosure.Button className='ease fixed right-5 top-36 z-40 flex h-14 w-52  items-center justify-center rounded-md bg-[#33bfb3] shadow-lg transition duration-300 hover:bg-indigo-600 focus:bg-indigo-600 focus:outline-none'>
